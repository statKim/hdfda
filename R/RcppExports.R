...
group_lla_admm <- function(Sigma, delta, s, Theta, lambda = 0.1, R = 1., a = 3.7, max_iter_lla = 100L, max_iter_admm = 100L, rho = 1.0, tol = 1e-5, tol_abs = 1e-4, tol_rel = 1e-3) {
    .Call(`_hdfda_group_lla_admm`, Sigma, delta, s, Theta, lambda, R, a, max_iter_lla, max_iter_admm, rho, tol, tol_abs, tol_rel)
}

group_lla_admm_warm_start <- function(Sigma, delta, s, Theta, lambda = 0.1, R = 1., a = 3.7, max_iter_lla = 100L, max_iter_admm = 100L, rho = 1.0, tol = 1e-5, tol_abs = 1e-4, tol_rel = 1e-3) {
    .Call(`_hdfda_group_lla_admm_warm_start`, Sigma, delta, s, Theta, lambda, R, a, max_iter_lla, max_iter_admm, rho, tol, tol_abs, tol_rel)
}
